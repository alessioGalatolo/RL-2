...
def main():
    ...
    agent = CleverAgent(n_actions, dim_state, device, eps_max, eps_min,
                        decay_period=decay_period, decay_method=decay_method)
    random_agent = RandomAgent(n_actions)

    # Training process
    replay_buffer = ReplayBuffer(replay_buffer_size, dim_state)
    ...
    scheduler = CosineAnnealingLR(optim_q, LR_decay_period, eta_min=min_lr)
